...
FAKE_VOID_FUNC(SetWindowIconWrapper, Image);
FAKE_VALUE_FUNC(Image, LoadImageWrapper, const char *);
...
TEST(RLWindowTest,
  ...
  ASSERT_EQ(SetWindowIconWrapper_fake.call_count, 1);
  ASSERT_EQ(LoadImageWrapper_fake.call_count, 1);
}
