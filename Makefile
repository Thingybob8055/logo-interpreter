...
OBJS = main.o file_importer.o pd_renderer.o pd_window.o movement.o logo_parser.o character_assembler.o pd_box.o rl_box.o rl_window.o raylib_wrapper.o rl_renderer.o logo_repeat_handler.o logo_line_break_handler.o
EXEC = bin/main
TEST_EXEC = bin/test_main
SRCS_MAIN = src/main.cc src/raylib_wrapper/raylib_wrapper.cc $(SRCS)
SRCS = src/importer/file_importer.cc src/renderer/pd_renderer.cc src/window/pd_window.cc src/movement/movement.cc src/parser/logo_parser.cc src/character_assembler/character_assembler.cc src/box/pd_box.cc src/box/rl_box.cc src/window/rl_window.cc src/renderer/rl_renderer.cc src/parser/logo_repeat_handler.cc src/parser/logo_line_break_handler.cc
