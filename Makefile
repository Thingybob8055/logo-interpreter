...
OBJS = main.o file_importer.o pd_renderer.o pd_window.o movement.o
EXEC = bin/main
TEST_EXEC = bin/test_main
SRCS_MAIN = src/main.cc $(SRCS)
SRCS = src/importer/file_importer.cc src/renderer/pd_renderer.cc src/window/pd_window.cc src/movement/movement.cc
TEST_SRCS = test/file_importer_test.cc test/pd_renderer_test.cc test/movement_test.cc test/test_all.cc $(SRCS)
