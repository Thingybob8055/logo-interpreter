...
SRCS = src/importer/file_importer.cc src/renderer/pd_renderer.cc src/window/pd_window.cc src/movement/pd_movement.cc src/parser/logo_parser.cc src/character_assembler/pd_character_assembler.cc src/box/pd_box.cc src/box/rl_box.cc src/window/rl_window.cc src/renderer/rl_renderer.cc src/parser/logo_repeat_handler.cc src/parser/logo_line_break_handler.cc src/movement/rl_movement.cc src/character_assembler/rl_character_assembler.cc
