...
SRCS = src/importer/file_importer.cc src/renderer/pd_renderer.cc src/window/pd_window.cc src/movement/movement.cc src/parser/logo_parser.cc src/character_assembler/character_assembler.cc src/box/pd_box.cc src/box/rl_box.cc src/window/rl_window.cc
