...
OBJS = main.o file_importer.o pd_renderer.o pd_window.o movement.o logo_parser.o character_assembler.o pd_box.o rl_box.o rl_window.o raylib_wrapper.o rl_renderer.o
EXEC = bin/main
TEST_EXEC = bin/test_main
SRCS_MAIN = src/main.cc src/raylib_wrapper/raylib_wrapper.cc $(SRCS)
SRCS = src/importer/file_importer.cc src/renderer/pd_renderer.cc src/window/pd_window.cc src/movement/movement.cc src/parser/logo_parser.cc src/character_assembler/character_assembler.cc src/box/pd_box.cc src/box/rl_box.cc src/window/rl_window.cc src/renderer/rl_renderer.cc
TEST_SRCS = test/file_importer_test.cc test/pd_renderer_test.cc test/movement_test.cc test/logo_parser_test.cc test/test_all.cc test/character_assembler_test.cc test/pd_window_test.cc test/main_test.cc test/rl_window_test.cc test/rl_box_test.cc test/rl_renderer_test.cc test/fff_common.cc $(SRCS)
